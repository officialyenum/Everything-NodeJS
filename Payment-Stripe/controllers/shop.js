...
exports.getProducts = (req, res, next) => {
  ...
  Product.find({}).count().then(numberTotal =>{
...
exports.getIndex = (req, res, next) => {
  ...
  Product.find({}).count().then(numberTotal =>{
    ...
    console.log("hasPrevious : "+ (page > 1));
    console.log("previous : "+ (page - 1));
    console.log("ITEMS_PER_PAGE * page : "+ (ITEMS_PER_PAGE * page));
    console.log("totalItems : "+ (totalItems));
    console.log("hasNext : "+ (ITEMS_PER_PAGE * page < totalItems));
